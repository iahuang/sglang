...
class Molmo2PoolingCrossAttention(nn.Module):
    ...
    Uses plain nn.Linear since it's a small module not TP-parallelized.
    """
...
class Molmo2VisionTransformer(nn.Module):
    ...
    def add_pos_emb(self, x: torch.Tensor, patch_num: Tuple[int, int]) -> torch.Tensor:
        ...
        if pos_emb.shape[0] != patch_num_0 or pos_emb.shape[1] != patch_num_1:
            ...
            # Use fp32 for bicubic interpolation to avoid fp16 overflow/NaN
...
class Molmo2ImageProjectorMLP(nn.Module):
    """SwiGLU-style MLP projector from vision features to text hidden size."""
...
# ==============================================================================
# Text Backbone Components (Qwen3-style pre-norm with per-head QK norm)
# ==============================================================================


class Molmo2Attention(nn.Module):
    """Attention for Molmo2-8B text backbone with Qwen3-style per-head QK norm."""
    ...
    def __init__(
        ...
        # Per-head QK normalization (Qwen3-style, norm dim = head_dim)
...
class Molmo2DecoderLayer(nn.Module):
    """Decoder layer for Molmo2-8B (pre-norm style)."""
    ...
    def __init__(
        ...
        # Pre-norm: attn_norm and ff_norm match HF checkpoint names
...
class Molmo2TextModel(nn.Module):
    ...
    def __init__(
        ...
        if self.pp_group.is_last_rank:
            ...
            self.ln_f = PPMissingLayer(return_tuple=True)
    ...
    def forward(
        ...
        for i in range(self.start_layer, self.end_layer):
            hidden_states, residual = self.blocks[i](
...
class Molmo2ForConditionalGeneration(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # Called by general_mm_embed_routine as the language_model
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            # Fused weights (att_proj, ff_proj) should be loaded directly
